...
class View {
	...
	public function __construct(){
		...
		if(Configure::getConfig('templateParseStr')){
			$templateParseStr = Configure::getConfig('templateParseStr');
	...
	public function display($templateFile=''){
		...
		if(file_exists($cacheFile) && time()-filemtime($cacheFile) < C('cacheLifeTime')){
